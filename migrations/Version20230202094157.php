 ...
 */
final class Version20230202094157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avoir (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE avoir_articles (avoir_id INT NOT NULL, articles_id INT NOT NULL, INDEX IDX_2E8FDA06C36D46DB (avoir_id), INDEX IDX_2E8FDA061EBAF6CC (articles_id), PRIMARY KEY(avoir_id, articles_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE avoir_media (avoir_id INT NOT NULL, media_id INT NOT NULL, INDEX IDX_67D5D51FC36D46DB (avoir_id), INDEX IDX_67D5D51FEA9FDD75 (media_id), PRIMARY KEY(avoir_id, media_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
